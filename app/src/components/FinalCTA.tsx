    ...
    <section className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="section-pad relative z-10" ref={ref}>
        <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }} className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-warm-800/50 text-lg md:text-xl leading-relaxed max-w-lg mx-auto mb-10">Gooblet is the financial companion you actually want to open. No lectures, no spreadsheets — just peace of mind.</p>
